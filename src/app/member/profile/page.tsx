        ...
        <div style={{ flex: "1 1 350px", background: "var(--card-bg)", padding: "clamp(1.5rem, 4vw, 2rem)", borderRadius: "16px", border: "1px solid var(--card-border)" }}>
          ...
          <form action={updateProfile} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
              ...
              <p style={{ fontSize: "0.8rem", color: "#64748b", margin: 0, marginTop: "0.5rem" }}>Club positions are assigned by administrators.</p>
            </div>

            <button type="submit" className="btn-primary" style={{ marginTop: "1rem" }}>Save Profile Details</button>
          </form>
        </div>
